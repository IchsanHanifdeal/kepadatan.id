...
<body class="bg-gray-200">
    ...
    <script src="assets/dashboard/assets/js/assets/dashboard/perfect-scrollbar.min.js"></script>
    <script src="assets/dashboard/assets/js/assets/dashboard/smooth-scrollbar.min.js"></script>
    <script>
